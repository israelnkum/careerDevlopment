...
return [
    ...
    'timestamp' => 1530210982,
    'checksum' => 'c946b6607b51d700aa7ea3a436f0fad2',
    'files' => [
        'templates/jl_fix_free/custom/particles' => [
            'particles/backtotop' => [
                'file' => 'templates/jl_fix_free/custom/particles/backtotop.yaml',
                'modified' => 1530210399
            ],
            'particles/search' => [
                'file' => 'templates/jl_fix_free/custom/particles/search.yaml',
                'modified' => 1530210399
            ],
            'particles/sticky' => [
                'file' => 'templates/jl_fix_free/custom/particles/sticky.yaml',
                'modified' => 1530210399
            ]
        ],
        'templates/jl_fix_free/particles' => [
            'particles/offcanvas-toggle' => [
                'file' => 'templates/jl_fix_free/particles/offcanvas-toggle.yaml',
                'modified' => 1530210399
            ]
        ],
        ...
        'templates/jl_fix_free/blueprints' => [
            'page' => [
                'file' => 'templates/jl_fix_free/blueprints/page.yaml',
                'modified' => 1530210399
            ],
            'styles/abovefooter' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/abovefooter.yaml',
                'modified' => 1530210399
            ],
            'styles/accent' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/accent.yaml',
                'modified' => 1530210399
            ],
            'styles/base' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/base.yaml',
                'modified' => 1530210399
            ],
            'styles/breakpoints' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/breakpoints.yaml',
                'modified' => 1530210399
            ],
            'styles/font' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/font.yaml',
                'modified' => 1530210399
            ],
            'styles/footer' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/footer.yaml',
                'modified' => 1530210399
            ],
            'styles/header' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/header.yaml',
                'modified' => 1530210399
            ],
            'styles/main' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/main.yaml',
                'modified' => 1530210399
            ],
            'styles/mainbody' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/mainbody.yaml',
                'modified' => 1530210399
            ],
            'styles/menu' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/menu.yaml',
                'modified' => 1530210399
            ],
            'styles/menustyle' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/menustyle.yaml',
                'modified' => 1530210399
            ],
            'styles/navigation' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/navigation.yaml',
                'modified' => 1530210399
            ],
            'styles/offcanvas' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/offcanvas.yaml',
                'modified' => 1530210399
            ],
            'styles/slideshow' => [
                'file' => 'templates/jl_fix_free/blueprints/styles/slideshow.yaml',
                'modified' => 1530210399
            ]
        ],
    ...
    'data' => [
        'items' => [
            ...
            'particles.search.icon' => [
                'type' => 'input.icon',
                'label' => 'Icon',
                'description' => 'Choose an icon.',
                'default' => 'fa fa-search',
                'name' => 'particles.search.icon'
            ],
            'particles.search.style' => [
                'type' => 'select.select',
                'label' => 'Style',
                ...
                'name' => 'particles.search.style'
            ],
            'particles.search.itemid' => [
                'type' => 'input.number',
                'label' => 'ItemID',
                ...
                'name' => 'particles.search.itemid'
            ],
            'particles.search.css' => [
                'type' => '_parent',
                'name' => 'particles.search.css',
                'form_field' => false
            ],
            'particles.search.css.class' => [
                'type' => 'input.selectize',
                'label' => 'CSS Classes',
                'description' => 'CSS class name for the particle.',
                'name' => 'particles.search.css.class'
            ],
            'particles.sticky' => [
                'type' => '_root',
                'form_field' => false,
            ...
            'styles.abovefooter.background-image' => [
                'type' => 'input.imagepicker',
                'label' => 'Background Image',
                'default' => 'gantry-media://background/above-ft-bg.png',
                'name' => 'styles.abovefooter.background-image'
            ],
            'styles.accent' => [
                'type' => '_root',
                'form_field' => false,
            ...
            'styles.mainbody.background' => [
                'type' => 'input.colorpicker',
                'label' => 'Background',
                'default' => '#ffffff',
                'name' => 'styles.mainbody.background'
            ],
        ...
        'nested' => [
            'particles' => [
                ...
                'search' => [
                    ...
                    'icon' => 'particles.search.icon',
                    'style' => 'particles.search.style',
                    'itemid' => 'particles.search.itemid',
                    'css' => [
                        'class' => 'particles.search.css.class'
                    ]
                ],
                'sticky' => [
            ...
            'styles' => [
                'abovefooter' => [
                    ...
                    'background-image' => 'styles.abovefooter.background-image'
                ],
                'accent' => [
                ...
                'mainbody' => [
                    'background' => 'styles.mainbody.background',
