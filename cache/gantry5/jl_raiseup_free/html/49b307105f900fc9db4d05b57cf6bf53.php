...
return [
    ...
    '_version' => 1,
    'id' => '5b379d0f67f4d6.40106751',
    'content' => '<div class="uk-section-default">
	<div class="uk-section uk-background-cover" style="background-image: url(/careerDev/bg.png?5b379c06)">
		<div class="uk-container uk-text-center">
			<h3 class="uk-text-uppercase">Why should I pay visit to the career Development Office?</h3>
			...
			<div class="uk-grid-match uk-child-width-1-3@m" uk-grid>
				...
				<div class="uk-card uk-card-hover uk-card-body uk-text-center">
					...
					<div class="uk-card-footer">
						<a href="http://localhost/careerDev/index.php/what-we-do" class="uk-button uk-button-text">Read more</a>
					</div>
				</div>
			</div>
		</div>
