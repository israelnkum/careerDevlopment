...
return [
    ...
    '_version' => 1,
    'id' => '5b3cd78d0ef5d1.61461564',
    'content' => '<div class="uk-section-default uk-section-large" id="payVisit">
			...
			<div class="uk-grid-match uk-child-width-1-2@m" uk-grid>
				<div style="color: black">
					<ul class="uk-list uk-list-striped">
						...
						<li>You are paying for it! Your fees have paid for the support the Career Development Office provides. Therefore, not taking advantage of it simply means you are not utilising some part of your fees.</li>
					</ul>
				</div>
				<div>
					<div class="uk-text-center">
						<div class="uk-inline-clip uk-transition-toggle" tabindex="0">
							<img src="/careerDev/crDev.jpg?5b3cd73c" style="height: 300px; width: 200px;" alt="">
