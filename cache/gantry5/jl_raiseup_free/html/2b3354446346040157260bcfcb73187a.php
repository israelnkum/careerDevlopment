...
return [
    ...
    '_version' => 1,
    'id' => '5b37a33f2257f3.74680948',
    'content' => '<div class="uk-section-default uk-section-large" id="acceptingOffer">
	<div class="uk-section uk-light uk-background-cover" style="background-image: url(/careerDev/firstSection.jpg?5b3601ad)">
		<div class="uk-container">
			<h2 style="color: black; font-size: 40px; font-weight: 300" class="uk-text-large">What We do - Accepting Offer</h2>
