...
return [
    ...
    '_version' => 1,
    'id' => '5b37a2ac974aa7.50653075',
    'content' => '<div class="uk-section-default uk-section-large" id="internshipEnded">
	<div class="uk-section uk-light uk-background-cover" style="background-image: url(/careerDev/firstSection.jpg?5b3601ad)">
		<div class="uk-container">
			<h2 style="color: black; font-size: 40px; font-weight: 300" class="uk-text-large">What We do - Internship Ended</h2>
