	...
	installation: {
		...
		download: function() {
			qx.installation.ajaxCall('download', {}, function(result){
				// Set the progress
				qx.installation.update( 'data-progress-download' , result , '10%');
		...
		cleanCache: function() {
			...
			qx.installation.ajaxCall('cleanCache', {}, function(result) {
				...
				qx.installation.update('data-progress-cleancache', result, '15%');
				if (!result.state) {
		...
		backupDatabase: function() {
			...
			qx.installation.ajaxCall('backupDatabase' , {} , function(result) {
				// Set the progress
				qx.installation.update( 'data-progress-backup' , result , '20%');
		...
		installComponent : function() {
			...
			{
				// Set the progress
				qx.installation.update( 'data-progress-component' , result , '30%');
		...
		installLibrary : function() {
			...
			{
				// Set the progress
				qx.installation.update( 'data-progress-library' , result , '40%');
		...
		syncdb: function()
		{
			...
			{
				// Set the progress
				qx.installation.update( 'data-progress-syncdb' , result , '90%');
